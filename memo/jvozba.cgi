...
print header, start_html(-title => 'Jvozba', -xbase =>
 'http://jwodder.freeshell.org/lojban/', -style => {-src => '../styles.css',
 -code => <<EOCSS });
td.kaicme {text-align: right; font-weight: bold; font-family: monospace; font-size: 10px; }
EOCSS
...
print br, p({-class => 'link'}, i('selzba fi la', a({-href =>
 '/downloads/lojban/jboval-src.tgz'}, 'jboval.'), 'poi bakfu'));
